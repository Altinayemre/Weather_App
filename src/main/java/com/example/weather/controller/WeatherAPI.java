...
@Validated
@Tag(name = "Weather Service API v1", description = "Weather Service API to search the current weather report of the city")
public class WeatherAPI {
    ...
    public ResponseEntity<WeatherDto> getWeatherByCityName(@PathVariable("city") @CityNameConstraint @NotBlank String city) {
